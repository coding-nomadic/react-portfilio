...
const MENU_LIST = [
    ...
    ['Contact', contactImage, "yellow-text"], ['Resume', resumeImage, "yellow-text"]
];
                    ...
                    <nav className="hide-on-small-only">
                        <ul className="sidenav sidenav-fixed section table-of-contents">
                            <li className="logo user-view">
                                <a href="#Introduction" className="logo-name teal-text"><h1>Tenzin Dawa</h1></a>
                                <a href="#Introduction" className="logo-name-desc brown-text">Software Engineer</a>
                            </li>
                            {fixedSidebarItems}
